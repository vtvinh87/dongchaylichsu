...
const TimelineSlot: React.FC<TimelineSlotProps> = ({ slotIndex, placedEvent, onDrop, onDragOver, totalSlots }) => {
  ...
  return (
    <div
      ...
      className={`timeline-slot-with-image relative flex-shrink-0 w-32 h-24 sm:w-36 sm:h-28 md:w-40 md:h-32 border-2 rounded-lg flex flex-col items-center justify-center p-2 text-center transition-colors duration-200
